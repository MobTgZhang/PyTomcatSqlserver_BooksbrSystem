...
from connect_db import get_number_usr,save_db_reader
class Register_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.postButton.clicked.connect(lambda : self.post_infor(Dialog))
    ...
    def post_infor(self,Dialog):
        ...
        if save_db_reader(str(dict_data),ip_address):
            ...
            QtWidgets.QMessageBox.information(None, "提示信息", "请重新登陆!", QtWidgets.QMessageBox.Yes)
            Dialog.close()
        else:
