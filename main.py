...
import sys
from connect_db import get_user_name
import os
import json
import requests
# 重写closeEvent函数
...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.clicked.connect(self.log_in_ext)
    ...
    def log_in_ext(self):
        try:
            ...
            QtWidgets.QMessageBox.warning(None,"错误提示","网络连接错误,请检查网络情况！")
    def log_in(self):
        typeUser = self.comboBox.currentIndex() + 1
